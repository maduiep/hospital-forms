...
$(document).ready(function () {
  $('.addmore').click(function(e){
    e.preventDefault();
      $('.utilize-data').append('<br><label for="diagnosis" class="form-label" style="padding-top: 1rem; padding-left: 2rem; color: rgb(129, 129, 199);">Utilizaton Category</label>'+
...
$(document).ready(function () {
  $('.add-input').click(function(e){
    e.preventDefault();
      $('.diagnosis-data').append('<br><label for="diagnosis" class="form-label" style="padding-top: 1rem; padding-left: 2rem; color: rgb(129, 129, 199);">Diagnosis Code</label>'+
      '<div class="form-floating">'+
